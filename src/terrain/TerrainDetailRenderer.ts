import { Scene, Vector3, Mesh, StandardMaterial, Texture, VertexData, Color3, ShaderMaterial, Effect } from '@babylonjs/core';
...
export class TerrainDetailRenderer {
  ...
  // Texture providers
  private _heightMapProvider: string = 'https://cloud.maptiler.com/tiles/terrain-rgb/{z}/{x}/{y}.png';
  private _normalMapProvider: string = 'https://cloud.maptiler.com/tiles/terrain-normals/{z}/{x}/{y}.png';
  private _detailTextureProvider: string = 'https://cloud.maptiler.com/tiles/satellite/{z}/{x}/{y}.jpg';
    ...
    const material = new ShaderMaterial(
      ...
      },
      {
        ...
        uniforms: [
          ...
          'cameraPosition', 'heightScale', 'detailScale', 'normalStrength',
          'blendDistance'
        ],
        samplers: [
          'diffuseSampler', 'heightSampler', 'normalSampler', 'detailSampler'
        ]
      }
    );
